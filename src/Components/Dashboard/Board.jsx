...
const Userform = () => {
  ...
  return (
    <div className="bg-gray-200 w-[83%] ml-64 ">
      ...
      <div className="h-[100%] border ml-3 shadow-lg bg-white w-[24%] rounded-md flex justify-between items-center ">
          <div>
            {" "}
            <h1 className="text-lg ml-3 mt-2 text-gray-500 ">Total Leads</h1>{" "}
        ...
        <div className="h-[100%] border ml-3 shadow-lg bg-white w-[24%] rounded-md flex justify-between items-center ">
          <div>
            {" "}
            <h1 className="text-lg ml-3 mt-2 text-gray-500  ">Today Leads</h1>{" "}
            <h1 className="font-bold ml-3 text-3xl">1</h1>
          </div>
          <div className="  text-center mt-1 h-10 bg-green-100 border items-center w-[14%] rounded-full mr-3"> 
          <BsSendArrowUpFill 
          size={20} className="text-green-500 ml-[16%] mt-[24%]" />
          </div>
        </div>
        ...
        <div className="h-[100%] border ml-3 shadow-lg bg-white w-[24%] rounded-md flex justify-between items-center ">
          <div>
            {" "}
            <h1 className="text-lg ml-3 mt-2 text-gray-500  ">Conversion Rate</h1>{" "}
            <h1 className="font-bold ml-3 text-3xl">1</h1>
          </div>
          <div className="  text-center mt-1 h-10 bg-yellow-100 border items-center w-[14%] rounded-full mr-3"> 
          <FaPercent  size={16} className="text-yellow-500 ml-[26%]   mt-[29%]" />
          </div>
        </div>
        <div className="h-[100%] border ml-3 shadow-lg bg-white w-[24%] rounded-md flex justify-between items-center">
          <div>
            {" "}
            <h1 className="text-lg ml-3 mt-2 text-gray-500  ">Approval Leads</h1>{" "}
            <h1 className="font-bold ml-3 text-3xl">1</h1>
          </div>
          <div className="  text-center mt-1 h-10 bg-sky-100 border items-center w-[14%] rounded-full mr-3"> 
          <FaCheckCircle 
          size={20} className="text-sky-500 ml-[22%]   mt-[20%]" />
          </div>
        </div>
      </div>
      ...
      <div className="h-[100%] border ml-3 shadow-lg bg-white w-[16%] rounded-md flex justify-between items-center ">
        ...
        <div className="h-[100%] border ml-3 shadow-lg bg-white w-[16%] rounded-md flex justify-between items-center ">
          ...
          <div className="  text-center mt-1 h-10 bg-blue-100 border items-center w-[19%] rounded-full mr-3"> 
          <IoMdCheckboxOutline 
          size={20} className="text-green-500 ml-[23%] mt-[25%] " />
          </div>
        </div>
        ...
        <div className="h-[100%] border ml-3 shadow-lg bg-white w-[16%] rounded-md flex justify-between items-center ">
          <div>
            {" "}
            <h1 className="text-md ml-3 mt-2 text-gray-500 ">Inprogress</h1>{" "}
            <h1 className="font-bold ml-3 text-3xl">1</h1>
          </div>
          <div className="  text-center mt-1 h-10 bg-blue-100 border items-center w-[19%] rounded-full mr-3"> 
          <FaFile  size={20} className="text-sky-500 ml-[23%]   mt-[23%]" />
  ...
  {PartnerData.map((item) => (
    <div key={item.id} className="w-[20%] h-[80%] shadow flex flex-col items-center">
